...
class GoogleCalendarFactory
{
    ...
    {
        // カレンダー連携に必要な情報を取得する
        $calendarConfigInfo = \Calendar::getGoogleCalendarConfigInfo();

        $config = $calendarConfigInfo;
    ...
    protected static function createServiceAccountClient(array $authProfile): Google_Client
    {
        ...
        if ($calendarConfigInfo['user_to_impersonate']) {
            $client->setSubject($calendarConfigInfo['user_to_impersonate']);
        }
